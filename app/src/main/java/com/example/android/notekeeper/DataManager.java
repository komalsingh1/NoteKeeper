...
public class DataManager {
    ...
    public int createNewNote() {
        com.example.android.notekeeper.NoteInfo note = new com.example.android.notekeeper.NoteInfo(null, null, null);
        mNotes.add(note);
        return mNotes.size() - 1;
    }

    public int findNote(com.example.android.notekeeper.NoteInfo note) {
